...
RedisProxy.prototype.handleOpen = function(fluidsync)
{
...
RedisProxy.prototype.handleClose = function(fluidsync, code, reason)
{
...
RedisProxy.prototype.handleCommandsFeedback = function(fluidsync, message)
{
...
RedisProxy.prototype.handlePubsubEvents = function(fluidsync, message)
{
    let payload = message.payload;
...
RedisProxy.prototype.handlePresence = function(fluidsync, message)
{
    let payload = message.payload;
...
RedisProxy.prototype.notifyListenersGeneral = function(eventType)
{
    let listeners = this.eventListeners.get(eventType);
